...
import tech.provve.api.client.auth.Authentication;
import tech.provve.api.client.auth.HttpBasicAuth;
import tech.provve.api.client.auth.HttpBearerAuth;
import tech.provve.api.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/beta/java");
     ...
     * @return a {@link tech.provve.api.client.ApiClient} object
     */
     ...
     * @throws tech.provve.api.client.ApiException If fail to execute the call
     */
     ...
     * @return Type
     * @throws tech.provve.api.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws tech.provve.api.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws tech.provve.api.client.ApiException If fail to read file content from response and write to disk
     */
     ...
     * @throws tech.provve.api.client.ApiException If fail to serialize the request body object
     */
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        final Request.Builder reqBuilder = new Request.Builder().url(buildUrl(
                baseUrl,
                path,
                updatedQueryParams,
                collectionQueryParams
     ...
     * @throws tech.provve.api.client.ApiException If fail to serialize the given object
     */
    ...
    public String buildUrl(String baseUrl, String path, List<Pair> queryParams, List<Pair> collectionQueryParams) {
        ...
        if (baseUrl != null) {
            ...
            if (serverIndex != null) {
                ...
                baseURL = servers.get(serverIndex)
                                 .URL(serverVariables);
            } else {
                baseURL = basePath;
            }
     ...
     * @param uri          URI
     * @throws tech.provve.api.client.ApiException If fails to update the parameters
     */
     ...
     * @throws tech.provve.api.client.ApiException If fail to serialize the request body object into a string
     */
