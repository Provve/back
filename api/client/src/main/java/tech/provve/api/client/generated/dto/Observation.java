...
public class Observation {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Observation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        ...
                        "The required field(s) %s in Observation is not found in the empty JSON string",
                        Observation.openapiRequiredFields.toString()
                ));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!Observation.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(
                        java.util.Locale.ROOT,
                        "The field `%s` in the JSON string is not defined in the `Observation` properties. JSON: %s",
                        entry.getKey(),
    ...
    public static Observation fromJson(String jsonString) throws IOException {
        return JSON.getGson()
                   .fromJson(jsonString, Observation.class);
    }

    public Observation violations(@javax.annotation.Nullable List<ViolationsEnum> violations) {
        this.violations = violations;
        return this;
    }

    public Observation addViolationsItem(ViolationsEnum violationsItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.violations, observation.violations);
    }
