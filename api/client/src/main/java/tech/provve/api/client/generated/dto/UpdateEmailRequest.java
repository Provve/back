...
public class UpdateEmailRequest {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateEmailRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(
                        ...
                        "The required field(s) %s in UpdateEmailRequest is not found in the empty JSON string",
                        UpdateEmailRequest.openapiRequiredFields.toString()
                ));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!UpdateEmailRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(
                        java.util.Locale.ROOT,
                        "The field `%s` in the JSON string is not defined in the `UpdateEmailRequest` properties. JSON: %s",
                        entry.getKey(),
    ...
    public static UpdateEmailRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson()
                   .fromJson(jsonString, UpdateEmailRequest.class);
    }

    public UpdateEmailRequest email(@javax.annotation.Nonnull String email) {
        this.email = email;
        return this;
    }
